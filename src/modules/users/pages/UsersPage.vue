...
const fetchCustomers = async () => {
  ...
  error.value = '';
  try {
    let url = '/infinity-booking/users/customers';
...
const updateStatus = async (customer, newStatus) => {
  try {
    await http.patch('/infinity-booking/users/customers/status', {
...
const deleteCustomer = async (customer) => {
  ...
  try {
    await http.delete(`/infinity-booking/users/${encodeURIComponent(customer._id)}`);
...
const submitNewCustomer = async () => {
  ...
  try {
    await http.post('/infinity-booking/users/customers', {
      fullname,
      email,
      password,
      address,
